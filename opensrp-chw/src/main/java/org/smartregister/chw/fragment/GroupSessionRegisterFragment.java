 ...
 */
public class GroupSessionRegisterFragment extends BaseRegisterFragment implements GroupSessionRegisterFragmentContract {

    @Override
    public void setupViews(View view) {
        super.setupViews(view);

        //Customizing the fragment look
        /**
    ...
    protected void initializePresenter() {
        //Initialize presenter for this fragment
    }
